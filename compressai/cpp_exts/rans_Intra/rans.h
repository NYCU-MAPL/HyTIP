 ...
 **/
class MLCodec_RansEncoder_IntraLib {
public:
  MLCodec_RansEncoder_IntraLib() = default;
  virtual ~MLCodec_RansEncoder_IntraLib() = default;

  MLCodec_RansEncoder_IntraLib(const MLCodec_RansEncoder_IntraLib &) = delete;
  MLCodec_RansEncoder_IntraLib(MLCodec_RansEncoder_IntraLib &&) = delete;
  MLCodec_RansEncoder_IntraLib &operator=(const MLCodec_RansEncoder_IntraLib &) = delete;
  MLCodec_RansEncoder_IntraLib &operator=(MLCodec_RansEncoder_IntraLib &&) = delete;
...
class MLCodec_RansEncoder_IntraLibMultiThread : public MLCodec_RansEncoder_IntraLib {
public:
  MLCodec_RansEncoder_IntraLibMultiThread();
  virtual ~MLCodec_RansEncoder_IntraLibMultiThread();
...
class MLCodec_RansDecoder_IntraLib {
public:
  MLCodec_RansDecoder_IntraLib() = default;
  virtual ~MLCodec_RansDecoder_IntraLib() = default;

  MLCodec_RansDecoder_IntraLib(const MLCodec_RansDecoder_IntraLib &) = delete;
  MLCodec_RansDecoder_IntraLib(MLCodec_RansDecoder_IntraLib &&) = delete;
  MLCodec_RansDecoder_IntraLib &operator=(const MLCodec_RansDecoder_IntraLib &) = delete;
  MLCodec_RansDecoder_IntraLib &operator=(MLCodec_RansDecoder_IntraLib &&) = delete;
